    ...
    return (
        <>
            ...
            <section className="max-w-5xl mx-auto px-4 py-16">
                ...
                <div className="p-6 rounded-lg border border-[var(--card-border)] bg-[var(--secondary)]">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] w-full max-w-xs text-center">
                            <div className="text-xs uppercase text-[var(--text-muted)]">Layer 1: Presentation</div>
                            <div className="font-semibold text-[var(--text-primary)] mt-2 flex items-center justify-center gap-2">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] w-full max-w-xs text-center">
                            <div className="text-xs uppercase text-[var(--text-muted)]">Layer 2: Application</div>
                            <div className="font-semibold text-[var(--text-primary)] mt-2 flex items-center justify-center gap-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
                        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] text-center">
                            <div className="text-xs uppercase text-[var(--text-muted)]">Layer 3a: Authentication</div>
                            <div className="font-semibold text-[var(--text-primary)] mt-2 flex items-center justify-center gap-2">
                                <Lock className="w-5 h-5 text-purple-500" />
                                Supabase Auth
                            </div>
                            <div className="text-xs text-[var(--text-muted)] mt-2">GitHub OAuth • Sessions</div>
                        </div>
                        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] text-center">
                            <div className="text-xs uppercase text-[var(--text-muted)]">Layer 3b: Data</div>
                            <div className="font-semibold text-[var(--text-primary)] mt-2 flex items-center justify-center gap-2">
                                <Database className="w-5 h-5 text-amber-500" />
                                PostgreSQL DB
                            </div>
                            <div className="text-xs text-[var(--text-muted)] mt-2">RLS • Triggers • RPCs</div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center mb-4">
                        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] w-full max-w-xs text-center">
                            <div className="text-xs uppercase text-[var(--text-muted)]">Layer 4: External API</div>
                            <div className="font-semibold text-[var(--text-primary)] mt-2 flex items-center justify-center gap-2">
                                <GraduationCap className="w-5 h-5 text-green-500" />
                                GGSIPU Result Systems
                            </div>
                            <div className="text-xs text-[var(--text-muted)] mt-1">Official results source (authorized)</div>
                        </div>
                    </div>
