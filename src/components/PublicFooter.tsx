        ...
        >
            <div className="px-[20%] py-16 sm:py-16 text-center relative z-10">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-xl sm:text-2xl text-[var(--text-primary)] font-semibold mb-3">
                ...
                {/* Divider */}
                <div className="h-px bg-gradient-to-r from-transparent via-[var(--card-border)] to-transparent mb-8"></div>

                {/* Bottom Info */}
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-[var(--text-muted)] text-sm">
